...
@section('isihalaman')
<br>
    <h3><center>Daftar Anggota Perpustakaan SMP Muhammadiyah 2 Minggir</center></h3>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/{{ $a->id_anggota}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <p>
                                            <div class="form-group row">
                                                <label for="prodi" class="col-sm-4 col-form-label">KELAS</label>
                                                <div class="col-sm-8">
                ...
                <div class="modal-body">
                    <form name="formanggotatambah" id="formanggotatambah" action="/anggota/tambah " method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="id_anggota" class="col-sm-4 col-form-label">NIS</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukan NIS">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="prodi" class="col-sm-4 col-form-label">KELAS</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="prodi" name="prodi" placeholder="Masukan KELAS">
                            </div>
                        </div>
